import { __awaiter as __awaiter_1, __rest } from "tslib";
...
const VideoPlayer = (tempProps) => {
    ...
    const setAudio = () => __awaiter_1(void 0, void 0, void 0, function* () {
        try {
    ...
    const togglePlay = () => __awaiter_1(void 0, void 0, void 0, function* () {
        if (controlsState === ControlStates.Hidden) {
            return;
        }
    ...
    return (<View style={{
            ...
            <TouchableWithoutFeedback onPress={animationShow}>
                <Animated.View style={Object.assign(Object.assign({}, StyleSheet.absoluteFillObject), { opacity: 1, justifyContent: 'center', alignItems: 'center' })}>
                    <View style={Object.assign(Object.assign({}, StyleSheet.absoluteFillObject), { opacity: 1 })}/>
                    <View style={styles.iconWrapperOuter} pointerEvents={controlsState === ControlStates.Visible ? 'auto' : 'none'}>
            ...
            shiftPosition(DEFAULT_STEP_SIZE);
                                ...
                                <View>
                                    <MaterialIcons name='arrow-forward' style={styles.iconSide} size={props.icon.size} color={props.icon.color}/>
                                </View>
                            </TouchableButton>
                        </View>
                    </View>
            ...
            }} onSlidingComplete={(e) => __awaiter_1(void 0, void 0, void 0, function* () {
                const position = e * playbackInstanceInfo.duration;
                if (playbackInstance) {
